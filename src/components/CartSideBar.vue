    ...
    <div>
        <aside class="cart-sidebar">
            ...
            <div class="cart-footer">
              <router-link class="cart-checkout-btn" :to="{name : 'checkout.page'}"><span class="checkout-label">Proceed to Checkout</span><span
                  class="checkout-price">$369.78</span></router-link>
            </div>
          </aside>
    </div>
</template>
